...
def inference_on_dataset(
    ...
    with ExitStack() as stack:
        ...
        dataset_lookup = {d["image_id"]: d for d in dataset_dicts}
        ...
        for i, inputs in enumerate(data_loader):
            ...
            gt_class_names = set()
            # 获取GT
            if idx in dataset_lookup:
                raw_ground_truth = dataset_lookup[idx]
                anns = raw_ground_truth['annotations']
                for ann in anns:
                    cls_id = ann['category_id']
                    cls_name = class_names[cls_id]
                    cls_name = cls_name[0].lower() + cls_name[1:]
                    gt_class_names.add(cls_name)
            ...
            outputs = model(inputs,gt_cls_names = gt_class_names)
